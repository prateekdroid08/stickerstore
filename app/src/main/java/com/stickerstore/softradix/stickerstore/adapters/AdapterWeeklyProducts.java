...
public class AdapterWeeklyProducts extends RecyclerView.Adapter<AdapterWeeklyProducts.RecyclerViewHolder> {
    ...
    public AdapterWeeklyProducts(Context context) {
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = inflater.inflate(R.layout.adapter_weekly_deals, parent, false);
